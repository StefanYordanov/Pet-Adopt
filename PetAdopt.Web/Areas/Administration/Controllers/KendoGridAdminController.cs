...
namespace PetAdopt.Web.Areas.Administration.Controllers
{
    ...
    {
        public KendoGridAdministrationController(IDeleteablePetAdoptData data)
            : base(data)
        {
        ...
        //private abstract void ChangeEntityStateAndSave(object dbModel, EntityState state);
